...
@Entity
@Table(name = "lh_notice_detail_source", uniqueConstraints = @UniqueConstraint(
		name = "uk_lh_notice_detail_source_key", columnNames = { "pan_id", "source_order", "dataset_type" }))
@Getter
...
public class LhNoticeDetailSource {
	...
	public LhNoticeDetailSource(int sourceOrder, String panId, String datasetType, String complexName,
			String address, String detailAddress, String totalUnitCount, String heatingDescription,
			String exclusiveAreaRange, String expectedMoveInYearMonth, String guidanceText, String applicationPeriod,
