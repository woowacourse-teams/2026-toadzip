...
@Service
public class LhNoticeSupplyCollectionService {

    private final LhNoticeExternalCollectionService collectionService;

    public LhNoticeSupplyCollectionService(LhNoticeExternalCollectionService collectionService) {
        this.collectionService = collectionService;
    }

    public ExternalDataCollectionReport collect() {
        return collectionService.collect(ExternalDataSource.LH_NOTICE_SUPPLY);
    }
}
